<style>
    ...
    #uploader .filelist li {
        width: 110px;
        height: 110px;
        background: url(../webuploader/bg.png) no-repeat;
        text-align: center;
        margin: 0 8px 20px 0;
        position: relative;
        display: inline;
    ...
    #uploader .filelist li p.progress span {
        ...
        width: 0;
        height: 100%;
        background: #1483d8 url(../webuploader/progress.png) repeat-x;
    ...
    #uploader .filelist li .success {
        ...
        width: 100%;
        z-index: 200;
        background: url(../webuploader/success.png) no-repeat right bottom;
    }
    ...
    (function ($) {
        ...
        $(function () {
            ...
            uploader = WebUploader.create({
                ...
                chunked: false,
                chunkSize: 512 * 1024,
                server: '/goods/goodsInfo/uploadFile.do',
                // runtimeOrder: 'flash',
